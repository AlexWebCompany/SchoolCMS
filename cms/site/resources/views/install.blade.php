<?php if(file_exists(__DIR__.'/../../../config/sqlcomplete.php')) {unlink(__DIR__.'/../../../config/sqlcomplete.php');} ?>
<!DOCTYPE html>
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">@lang('config.install') @lang('main.cmsname')</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" action="/install/apply"@if (config('app.getpost')==true) method="post" @endif>
					...
					<?=Helper_TimeZone::getTimeZoneSelect(date_default_timezone_get());?>
					<div class="form-group">
                    ...
                    <div class="form-group">
					<label class="col-md-4 control-label">@lang('config.prefix'): </label>
					<div class="col-md-6"><input type="text" placeholder="@lang('config.prefix')" name="sqliteprefix" value="{{ config('database.connections.sqlite.prefix') }}" class="form-control">
					</div>
					</div>
                    </div>
                    <p><input type="checkbox" name="debug" value="true">@lang('config.ondebug')</p>
